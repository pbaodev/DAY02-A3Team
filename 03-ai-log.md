...
### Tác vụ 2: Đóng vai Hội đồng Thẩm định JCI & Pháp chế Y khoa để Stress-test Thẻ bài toán (Phase 2)
...
## 2. AI Đã Sai / Xuất Hiện Ảo Giác (Hallucination) Ở Đâu? (2 Case Nghiên Cứu Điển Hình)
...
## 3. Tôi Đã Sửa Prompt & Thiết Lập Ranh Giới Ra Sao? (Before vs After)
...
│ Hậu quả: Bịa liều thuốc, sinh văn tự     │     │ 3. ZERO HALLUCINATION (Copy meds as-is). │
...
4. **Kiểm chứng thực nghiệm:** Đưa 3 kịch bản Adversarial tests vào file `prompt_prototype.py`, chạy kiểm thử vượt qua 100% assertions an toàn.
